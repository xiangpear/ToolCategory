<template>
    <!-- 条件筛选 -->
    <div class="makeid-table-query" :style="{ height: '100%' }">
        <!-- 条件筛选标题 -->
        ...
        <!-- 条件筛选表单内容 -->
        <div class="query-content" :style="{ width: '100%' }">
            <el-form :inline="true" size="small">
                ...
                <div class="query-btn" :class="isExpand">
                    ...
                    <el-button icon="el-icon-refresh-left" @click="resetQuery" size="small">重置</el-button>
                    <!-- <div v-if="moreShow" class="more" @click="moreQuery">{{ queryMoreTxt }} <i :class="queryMoreIcon"></i></div> -->
                </div>
            </el-form>
        </div>
