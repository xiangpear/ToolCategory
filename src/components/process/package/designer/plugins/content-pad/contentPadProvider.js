...
ContextPadProvider.prototype.getContextPadEntries = function (element) {
    ...
    if (is(businessObject, "bpmn:FlowNode")) {
        if (is(businessObject, "bpmn:EventBasedGateway")) {
            ...
            assign(actions, {
                ...
                "append.exclusive-gateway": appendAction("bpmn:ExclusiveGateway", "bpmn-icon-gateway-xor", translate("追加互斥网关")),
                "append.parallel-gateway": appendAction("bpmn:ParallelGateway", "bpmn-icon-gateway-parallel", translate("追加并行网关")),
                "append.append-task": appendAction("bpmn:UserTask", "bpmn-icon-user-task", translate("追加用户任务")),
    ...
    if (deleteAllowed) {
        if (businessObject.elementType != "default") {
            assign(actions, {
                delete: {
                    group: "connect",
