...
F.prototype.getPaletteEntries = function () {
    ...
    assign(actions, {
        ...
        "create.exclusive-gateway": createAction("bpmn:ExclusiveGateway", "gateway", "bpmn-icon-gateway-xor", translate("创建互斥网关")),
        "create.exclusive-parallel": createAction("bpmn:ParallelGateway", "gateway", "bpmn-icon-gateway-parallel", translate("创建并行网关")),
