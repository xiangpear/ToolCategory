                ...
                <el-row :gutter="10">
                    ...
                    <el-col :span="12">
                        <el-form-item label="监听器类型" prop="listenerType">
                            <el-select @change="listenerTypeChange" v-model="listenerForm.listenerType" clearable>
                    ...
                    <el-col :span="24">
                        <el-form-item v-if="listenerForm.listenerType === 'classListener'" label="Java类" prop="class" key="listener-class">
                            <el-input v-model="listenerForm.class" clearable placeholder="请输入Java类" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                    ...
                    <el-col :span="24">
                        <el-form-item v-if="listenerForm.listenerType === 'delegateExpressionListener'" label="代理表达式" prop="delegateExpression" key="listener-delegate">
                            <el-input v-model="listenerForm.delegateExpression" clearable placeholder="请输入代理表达式" />
                        </el-form-item>
                    </el-col>
...
export default {
    ...
    methods: {
        ...
        disabledShow(row) {
            // return row.class == "com.makeid.process.base.listener.ExecutionCreateListener";
            return false;
        },

        // 是否为总节点
        isProcess() {
            return this.bpmnElement.type == "bpmn:Process";
        },
        ...
        removeListener(listener, index) {
            this.$confirm("确认移除该监听器吗？", "提示", {
                ...
                .then(() => {
                    this.bpmnElementListeners.splice(index + 1, 1);
        ...
        async saveListenerConfig() {
            ...
            // console.log(listenerObject, this.bpmnElement, this.prefix);
            if (this.editingListenerIndex === -1) {
                this.bpmnElementListeners.push(listenerObject);
                this.elementListenersList.push(this.listenerForm);
            } else {
                this.bpmnElementListeners.splice(this.editingListenerIndex + 1, 1, listenerObject);
