<template>
    <account-template :tableLine="tableLine" name="collect">
        <template v-slot:query="{ queryForm }">
            ...
            <!-- <el-form-item label="上次实验日期：">
                <el-date-picker
                    :default-time="['00:00:00', '23:59:59']"
                    v-model="queryForm.lastInspectionTime"
                    type="datetimerange"
                    range-separator="至"
...
export default {
    ...
    data() {
        this.tableLine = accountData.tableLine_receive;
        return {
            options: {
                toolCategory: [],
                stores: [],
