<template>
    <div id="launched">
                    ...
                    <el-table-column label="操作" align="center" width="230" fixed="right">
                        <template slot-scope="scope">
                            <div class="func-btns">
                                ...
                                <template v-if="!(scope.row.auditState == '已完成' || scope.row.auditState == '已撤销')">
                                    <el-button size="mini" type="text" icon="el-icon-refresh-left" @click="revoke(scope.row)">撤销 </el-button>
                                </template>
                                <template v-else>
        ...
        <!-- 流程弹框 -->
        <approveDialog v-if="approveVisable" ref="approve" :footershow="false" @refreshDataList="getDataList"> </approveDialog>
    </div>
</template>
